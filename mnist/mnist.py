...
def load_data(one_hot=True, reshape=None, flatten=False, validation_size=10000):
    x_tr = load_images('train-images-idx3-ubyte.gz', flatten)
    y_tr = load_labels('train-labels-idx1-ubyte.gz')
    x_te = load_images('t10k-images-idx3-ubyte.gz', flatten)
...
def load_images(filename, flatten):
